...
#[derive(Debug, Clone)]
struct NativeRdpSession {
    mounted_rect: Option<NativeHostRect>,
    visible: bool,
    control_tx: std_mpsc::Sender<NativeRdpSidecarCommand>,
}
...
#[cfg(windows)]
fn native_rdp_sidecar_path() -> Option<PathBuf> {
...
#[tauri::command]
fn launch_mstsc_rdp(config: RdpConnectConfig) -> Result<(), String> {
    #[cfg(not(windows))]
    {
        let _ = config;
...
#[tauri::command]
fn create_native_rdp_session<R: Runtime>(
    app: AppHandle<R>,
    state: State<'_, AppState>,
    config: RdpConnectConfig,
) -> Result<String, String> {
...
#[tauri::command]
fn mount_native_rdp_session<R: Runtime>(
    app: AppHandle<R>,
    state: State<'_, AppState>,
    session_id: String,
    rect: NativeHostRect,
...
#[tauri::command]
fn set_native_rdp_session_visible<R: Runtime>(
    app: AppHandle<R>,
    state: State<'_, AppState>,
    session_id: String,
    visible: bool,
...
#[tauri::command]
fn focus_native_rdp_session<R: Runtime>(
    app: AppHandle<R>,
    state: State<'_, AppState>,
    session_id: String,
) -> Result<(), String> {
...
#[tauri::command]
fn close_native_rdp_session<R: Runtime>(
    app: AppHandle<R>,
    state: State<'_, AppState>,
    session_id: String,
) -> Result<(), String> {
...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            create_ssh_session,
            create_rdp_session,
            create_native_rdp_session,
            mount_native_rdp_session,
            set_native_rdp_session_visible,
            focus_native_rdp_session,
            close_native_rdp_session,
            launch_mstsc_rdp,
            sftp_upload_file,
            sftp_upload_files,
            cancel_sftp_upload,
