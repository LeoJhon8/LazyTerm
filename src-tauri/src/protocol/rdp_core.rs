...
use ironrdp::connector::sspi::credssp::{self, CredSspClient, ClientState};
...
pub type UpgradedFramed = ironrdp_blocking::Framed<rustls::StreamOwned<rustls::ClientConnection, TcpStream>>;
